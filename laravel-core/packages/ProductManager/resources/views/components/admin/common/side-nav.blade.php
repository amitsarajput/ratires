  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="{{ route('admin.tyre.index') }}" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ route('admin.tyre.index') }}" class="nav-link {{request()->routeIs(['admin.tyre.*','admin.tyrecategory.*'])?'active':''}}">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{ route('admin.tyre.index') }}" class="nav-link {{request()->routeIs('admin.tyre.index')?'active':''}}">
                    <i class="nav-icon far fa-circle text-warning"></i>
                    <p>
                      Tyres
                    </p>
                ...
                <li class="nav-item">
                  <a href="{{ route('admin.tyre.reorder') }}" class="nav-link {{request()->routeIs('admin.tyre.reorder')?'active':''}}">
                    <i class="nav-icon far fa-circle text-warning"></i>
                    <p>
                      Tyre Reorder
                    </p>
