...
class RegionController extends Controller
{
    ...
    {
        $rgn=Region::all();
        return view('ProductManager::admin.region.index' ,compact('rgn'));
    }
    ...
    public function create()
    {
        ...
        return view('ProductManager::admin.region.create', compact('search_tags_all'));
    }
    ...
    public function edit(Region $rgn) 
    {
        ...
        $search_tags_all=SearchTag::all()->pluck('name','id');
        return view('ProductManager::admin.region.edit' ,compact('rgn','search_tags_all'));
    }
    ...
    public function destroy(Region $rgn)
    {
        if($rgn->id){
            $rgn->delete();
            return redirect()->route('ProductManager::admin.rgn.index')->with('status','Region deleted');
        }
    }
}
