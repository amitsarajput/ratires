...
<!-- Page Title
    ============================================= -->
    <x-page-title image-url="{{ asset('images/banner--warranty-us.webp') }}" container="true" page-title="" class="page-title--left el-height-70 uppercase" />
	...
	<section id="content">
		<div class="section bg-white pt-0">
			<div class="container">
				<div class="grid ">
					<div class="col-md-12 col-bleed-y center"><h2>LIMITED WARRANTY - NORTH AMERICA</h2></div>
				</div>
			</div>
			<div class="container">
				<div class="grid">
					<div class="col-md-12 col-bleed-y ">
						...
						<p class="text-sm"><sup>1</sup>  These warranties are offered on selected ranges. Please refer to the Quick Reference Guide for the most updated list of eligible ranges.</p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="container">
				<div class="grid">
					<div class="col-md-12 col-bleed-y ">
						...
						<ul class="text-md no-bullets li-icons">
							<li class="mb-xxs-1"><a target="_blank" href="{{ asset('storage/colletrals/radar-us-warranty/Radar_Quick_Reference_Guide_202406.pdf') }}"><x-icon-download-ico class="dark-100" /> Limited Warranty Quick Reference Guide</a>  – Passenger and Light Truck replacement tires purchased from October 1, 2020 to January 31, 2025</b></li>
							<li class="mb-xxs-1"><a target="_blank" href="{{ asset('storage/colletrals/radar-us-warranty/Radar_Warranty_Flyer.pdf') }}"><x-icon-download-ico class="dark-100" /> Limited Warranty Booklet </a>  - Passenger and Light Truck replacement tires purchased from October 1, 2020 to January 31, 2025</b></li>
						</ul>
					</div>
				</div>
			</div>
