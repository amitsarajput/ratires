    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Brand Extra Details </h3>
          ...
          <!-- /.card-header -->
          <!-- form start -->
          {!! Form::open(['route'=>'admin.brandextradetail.store']) !!}
            <div class="card-body">
                    @if ($errors->any())
              ...
              <div class="form-group">
                ...
                {{ Form::textarea('text', '', ['class'=>'form-control','placeholder'=>'Enter text', 'rows'=>6] ) }}
              </div>
              <div class="form-group">
                <label for="exampleInputPassword1">Slider</label>
                {{ Form::textarea('slider', '', ['class'=>'form-control','placeholder'=>'Enter slider', 'rows'=>6] ) }}
              </div>
            </div>
            <!-- /.card-body -->
