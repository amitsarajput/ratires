      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <a href="{{route('admin.season.create')}}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Create</a>  
                      ...
                      <td>
                        <div class="btn-group">
                          ...
                          <div class="dropdown-menu" role="menu">
                            <a class="dropdown-item" href="{{ route('admin.season.edit', $row->id) }}">Edit</a>
                            <form action="{{ route('admin.season.destroy', $row->id) }}" method="post">
                              @csrf
                              @method('DELETE')
