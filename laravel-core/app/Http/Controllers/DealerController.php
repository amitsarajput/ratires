...
class DealerController extends Controller
{
    ...
    { 
        ...
        return view('admin.dealer.create', compact('continents'));
    }
    ...
    public function edit(Dealer $dealer)
    {
        ...
        return view('admin.dealer.edit',compact('dealer','id','continents'));
    }
    ...
    public function bulkadd(Request $request)
    {
        if($request->method()==='GET'){
            ...
            //Load view
            return view('admin.dealer.bulk-add',compact('old_file'));
        }
