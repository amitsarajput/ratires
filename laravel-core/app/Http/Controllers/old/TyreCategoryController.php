...
class TyreCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.tyrecategory.index', compact('tyrecategory'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.tyrecategory.create');
    }
    ...
    public function destroy(TyreCategory $tyreCategory)
    {
        if($tyreCategory->id){
            ...
            $tyreCategory->delete();
            return redirect()->route('admin.tyrecategory.index')->with('status','Tyre Category deleted');
        }
    }
}
